# Troubleshooting — IT-Stack SNIPEIT
...
docker compose logs --tail=50 snipeit
...
1. Check logs: docker compose logs snipeit
...
```bash
# Test connectivity
psql -h lab-db1 -U snipeit_user -d snipeit_db -c '\conninfo'
...
1. Check resource usage: docker stats it-stack-snipeit
...
| Log | Path |
|-----|------|
| Application | docker compose logs snipeit |
