# Lab 16-05 — Advanced Integration

**Module:** 16 — Snipe-IT IT asset management  
**Duration:** See [lab manual](https://github.com/it-stack-dev/it-stack-docs)  
**Test Script:** 	ests/labs/test-lab-16-05.sh  
**Compose File:** docker/docker-compose.integration.yml

## Objective

Connect snipeit to the full IT-Stack ecosystem (FreeIPA, Traefik, Graylog, Zabbix).

## Prerequisites

- Labs 16-01 through 16-04 pass
